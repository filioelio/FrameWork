...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-12-2016 a las 21:45:25
-- Versión del servidor: 10.1.13-MariaDB
-- Versión de PHP: 7.0.5
CREATE DATABASE IF NOT EXISTS hopedaje;
USE hopedaje;
...
(SELECT COUNT(*) FROM reservacion re INNER JOIN habitacion ha ON ha.id_habitacion = re.fk_id_habitacion WHERE (DATEDIFF(fecha_ingreso, NOW()) = '1' OR DATEDIFF(fecha_ingreso, NOW()) = '0') AND ha.estado='Disponible' AND re.estado != 'Cancelado' ) as reservado, 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `HabitacionesOcupados` ()  BEGIN
  ...
  CONCAT(
    ...
    FROM TIMEDIFF
      ...
      WHERE
        ho.estado = 'Activo' and ha.estado = 'Ocupado' 
        ...
        (
          COALESCE(
            ...
            FROM TIMEDIFF
              ...
              FROM TIMEDIFF
                (NOW(),
                ho.fecha_ingreso)) > 4 THEN EXTRACT(
                  DAY
                FROM TIMEDIFF
                  (NOW(),
              ...
              (
                (
                  ...
                  INNER JOIN
                    huesped hu ON ho.fk_id_huesped = hu.id_huesped
                  WHERE
 ha.id_habitacion = id_habi AND ho.estado = 'Activo';
END$$
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `HospedajeSave` (IN `motivo` VARCHAR(60), IN `f_ingreso` DATETIME, IN `f_salida` DATETIME, IN `estado` VARCHAR(30), IN `costo` DECIMAL(10,2), IN `id_usuario` CHAR(8), IN `id_huesped` CHAR(8), IN `id_habitacion` CHAR(8))  BEGIN
...
INSERT INTO `hospedaje`(`id_hospedaje`, `motivo_visita`, `fecha_ingreso`, `fecha_salida`, `estado`, `costo_total`, `fk_id_usuario`, `fk_id_huesped`, `fk_id_habitacion`) VALUES ('', motivo, f_ingreso, f_salida, estado, costo,id_usuario, id_huesped, id_habitacion);
ELSE
INSERT INTO `hospedaje`(`id_hospedaje`, `motivo_visita`, `fecha_ingreso`, `fecha_salida`, `estado`, `costo_total`, `fk_id_usuario`, `fk_id_huesped`, `fk_id_habitacion`) VALUES ('','','','','','','','','');
END IF;
END$$
...
WHERE ha.estado = 'Disponible' AND re.estado != 'Cancelado' AND (DATEDIFF(re.fecha_ingreso, NOW()) = '1' OR DATEDIFF(re.fecha_ingreso, NOW()) = '0');
END$$
...
INSERT INTO `personal` (`id_personal`, `nombre`, `apellido`, `telefono`, `direccion`, `fecha_inicio`, `labor`, `salario`, `estado`, `fk_id_usuario`) VALUES
('47050210', 'Algirio', 'Sanchez Valasques', '963854112', 'Av. Abancay', '2016-12-02', 'Personal de Limpieza', '800.00', 'Inactivo', '47050254'),
('47050211', 'Maria', 'Huriguela Ramos', '968547142', 'Urb. Sinchi Roca', '2016-12-05', 'Personal de Limpieza', '800.00', 'Activo', '47050254'),
('47050212', 'Angel', 'Roman Quispe', '965841235', 'Urb. Las Palmeras', '2016-12-05', 'Personal de Seguridad', '1200.00', 'Activo', '47050254'),
('47050213', 'Felipe', 'Segarra Carrasco', '965874523', 'Urb. Las Palmeras', '2016-12-05', 'Personal de Seguridad', '1200.00', 'Activo', '47050254'),
('47050214', 'Angelica', 'Quillo Rios', '968547896', 'Urb. Las Palmeras', '2016-12-05', 'Personal de Limpieza', '800.00', 'Inactivo', '47050254'),
('47050215', 'Alejandra', 'Gimenez Sanchez', '962548965', 'Av. Pachacutec', '2016-12-11', 'Atención al Cliente', '1200.00', 'Activo', '47050254');
...
(1, 'Inca Kola', '2.25', 'Litros', '5.00', 224, 'Inca Kola.png'),
(2, 'Coca Cola', '1.25', 'Litros', '3.00', 214, 'Inca Cola.png'),
(3, 'Agua Cielo', '1', 'Litros', '1.00', 160, 'Agua Mineral.png'),
(4, 'Charada', 'galleta', 'Unidad', '1.00', 108, 'Charada.png'),
(5, 'Casino', 'Galleta', 'Unidad', '1.00', 133, 'Casino .png'),
(6, 'Morochas', 'Galleta', 'Unidad', '1.00', 163, 'morochas.png'),
(7, 'Morochas snack', 'Galleta', 'Unidad', '2.00', 101, 'Morochas snack.png'),
(8, 'Frugos Durasno', '1', 'Litros', '3.50', 218, 'Frugos .png'),
(9, 'Fanta', '500', 'ML', '2.00', 164, 'Fanta.png'),
(10, 'Colgate', 'Colinos', 'Unidad', '8.00', 84, 'Colgate.png'),
(11, 'Kolynos', 'colinos', 'Unidad', '5.00', 197, 'Kolynos.png'),
(12, 'Cepillo Dental', 'Colgate', 'Unidad', '2.50', 199, 'Cepillo Dental.png'),
(13, 'Prestobarba', 'Gillette Prestobarba  para afeitar', 'Unidad', '3.50', 176, 'Prestobarba.png'),
(14, 'Kotex', 'kotes contra fugas', 'Unidad', '5.50', 140, 'Kotex.png'),
(15, 'Protex', 'para la buena salud', 'Unidad', '2.00', 197, 'Protex.jpg'),
(16, 'Peine', 'Peine par Cabello', 'Unidad', '1.00', 182, 'Peine.png'),
(17, 'Power', 'Bebida Power', 'Unidad', '2.50', 156, 'Power.jpg'),
(18, 'Vinos', 'Vinos de Mesa', 'Unidad', '20.00', 143, 'Vinos.jpg'),
(19, 'heard shoulders', 'shampoo HS', 'Unidad', '2.00', 112, 'heard shoulders.jpg'),
(20, 'Condones Piel', 'Condones Piel', 'Unidad', '3.50', 350, 'condon Piel.png');
...
ALTER TABLE `personal`
  ...
  ADD KEY `personal_ibfk_1` (`fk_id_usuario`);
...
ALTER TABLE `venta`
  ...
  ADD KEY `fk_id_usuario` (`fk_id_usuario`),
  ADD KEY `fk_id_hopedaje` (`fk_id_hospedaje`);
...
--
ALTER TABLE `auditoriahospedaje`
  MODIFY `id_auditoria` int(8) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `detalle_venta`
  MODIFY `id_detalle_venta` int(8) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `eventos`
--
ALTER TABLE `eventos`
  MODIFY `id_eventos` int(8) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `gasto`
--
ALTER TABLE `gasto`
  MODIFY `id_gasto` int(8) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `hospedaje`
--
ALTER TABLE `hospedaje`
  MODIFY `id_hospedaje` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;
--
-- AUTO_INCREMENT de la tabla `permiso`
--
ALTER TABLE `permiso`
  MODIFY `id_permiso` int(8) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `reservacion`
  MODIFY `id_reservacion` int(8) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `venta`
  MODIFY `id_venta` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=98;
--
...
--
ALTER TABLE `auditoriahospedaje`
  ADD CONSTRAINT `auditoriahospedaje_ibfk_1` FOREIGN KEY (`fk_id_hospedaje`) REFERENCES `hospedaje` (`id_hospedaje`),
  ADD CONSTRAINT `auditoriahospedaje_ibfk_2` FOREIGN KEY (`fk_id_usuario`) REFERENCES `usuario` (`id_usuario`);

--
-- Filtros para la tabla `auditoriaventa`
--
ALTER TABLE `auditoriaventa`
  ADD CONSTRAINT `auditoriaventa_ibfk_1` FOREIGN KEY (`fk_id_venta`) REFERENCES `venta` (`id_venta`),
  ADD CONSTRAINT `auditoriaventa_ibfk_2` FOREIGN KEY (`fk_id_usuario`) REFERENCES `usuario` (`id_usuario`);
...
ALTER TABLE `detalle_venta`
  ...
  ADD CONSTRAINT `detalle_venta_ibfk_2` FOREIGN KEY (`fk_id_venta`) REFERENCES `venta` (`id_venta`);
...
--
ALTER TABLE `usuario`
  ADD CONSTRAINT `usuario_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id_usuario`);
