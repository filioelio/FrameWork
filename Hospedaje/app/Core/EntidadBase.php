<?php namespace App\Core;
    ...
    class EntidadBase
    {
        ...
        /*    **    */    
         ...
         public function getIdLast($class_name = "stdClass")
        {
            $query = $this
                        ->db
                        ->query("SELECT * FROM $this->table ORDER BY id_$this->table DESC LIMIT 1");
        ...
        public function getlIKE($column, $value, $class_name = "stdClass")
        {
            $query = $this
                        ->db
                        ->query("SELECT * FROM $this->table  WHERE $column LIKE '$value%' ORDER BY id_$this->table DESC");
        ...
        /*    **    */    
         ...
         /*        OBTIENE TODOS LOS ELEMENTOS DESPUES DE LA FECHA DE REGISTRADA         */
            
        public function getMajorDate($column, $value, $class_name = "stdClass")
        {
            $query = $this
                        ->db
                        ->query("SELECT * FROM $this->table  WHERE $column >= '$value' ORDER BY id_$this->table DESC");
